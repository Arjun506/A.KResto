...
## 4. Active Backend Milestone

**Sprint 1 — Milestone 1B (Business Workspace API)** is implemented on branch `business-os-v2`:

- Base prefix: `/api/v1`
- `POST /api/v1/business/workspace` — transactional workspace provisioning
- `GET /api/v1/business/check-name|industries|currencies|timezones` — onboarding lookups
- Implementation: `apps/api/src/business/`
- Spec: `docs/business-os-engines/business-engine/`
