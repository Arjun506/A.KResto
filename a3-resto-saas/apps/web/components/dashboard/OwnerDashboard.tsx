  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto px-4 sm:px-6">
      ...
      <section className="grid gap-4 grid-cols-2 md:grid-cols-3 lg:grid-cols-6">
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-100 shadow-xs hover:shadow-md transition-shadow duration-200">
          <div className="flex items-center justify-between">
            <span className="text-[10px] text-slate-500 font-bold uppercase tracking-wider">Total Guests</span>
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-100 shadow-xs hover:shadow-md transition-shadow duration-200">
          <div className="flex items-center justify-between">
            <span className="text-[10px] text-slate-500 font-bold uppercase tracking-wider">Tables Seated</span>
            <span className="rounded-full bg-cyan-50 p-1 text-cyan-600">
              <Layers className="h-3.5 w-3.5" />
            </span>
          </div>
          <h3 className="text-xl font-bold text-slate-900 mt-2">8 / 20</h3>
          <span className="text-[10px] text-slate-400 font-semibold mt-1 block">12 Available slots</span>
        </div>

        {/* Metric: Pending Orders */}
        <div className="bg-white p-5 rounded-2xl border border-slate-100 shadow-xs hover:shadow-md transition-shadow duration-200">
          <div className="flex items-center justify-between">
            <span className="text-[10px] text-slate-500 font-bold uppercase tracking-wider">Pending KOT</span>
            <span className="rounded-full bg-rose-50 p-1 text-rose-600">
              <AlertTriangle className="h-3.5 w-3.5" />
            </span>
          </div>
          <h3 className="text-xl font-bold text-rose-600 mt-2">12</h3>
          <span className="text-[10px] text-rose-600 font-semibold mt-1 block">↓ 5.2% KOT load</span>
        </div>
      </section>
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white p-5 rounded-2xl border border-slate-200/80 shadow-sm space-y-4">
            <div className="flex justify-between items-center border-b border-slate-100 pb-3">
              <h2 className="font-bold text-sm text-slate-800 uppercase tracking-wider">Top Selling Dishes</h2>
              <button className="text-xs font-bold text-indigo-600 hover:text-indigo-800" onClick={() => router.push('/dashboard/menu')}>
                View All
              </button>
            </div>
            ...
            <div className="space-y-3 text-xs">
              {[
                ...
                { name: 'Veg Biryani Special', count: 210, sales: '₹37,800' },
                { name: 'Margherita Pizza Regular', count: 185, sales: '₹29,600' },
                { name: 'Butter Garlic Naan', count: 162, sales: '₹24,300' },
              ].map((item) => (
                <div key={item.name} className="flex justify-between items-center font-semibold text-slate-600">
                  ...
                  <span className="text-slate-400 font-medium text-[10px]">{item.count} orders</span>
