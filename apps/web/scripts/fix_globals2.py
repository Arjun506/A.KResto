...
if start==-1:
    print('no hero-video-layer::after found')
else:
    end = s.find('\n}\n\n', start)
    if end==-1:
        print('could not find end of ::after block')
    else:
        # construct correct after block
